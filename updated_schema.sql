...
CREATE TABLE IF NOT EXISTS properties (
  ...
  "ownershipYears" TEXT, -- Changed to match form field name
  "timeToAttractions" TEXT, -- Changed to match form field name
...
CREATE TABLE IF NOT EXISTS blog_posts (
  ...
  author TEXT,
  featured_image TEXT,
  slug TEXT, -- Add slug field for URL-friendly identifiers
